      ...
      <div className="max-w-6xl mx-auto px-4 py-3.5 flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          <div className="flex items-center gap-1.5 relative">
            ...
            {/* 1. MENU: CEK STATUS GIZI (Dengan efek hover & tap yang lebih interaktif) */}
            <NavLink
              to="/cek"
              className={({ isActive }) =>
            ...
            {/* 5. DROPDOWN GROUP: PUSAT EDUKASI */}
            {user && (
              <div 
                className="relative"
          ...
          {/* 6. AUTH SECTION (Animasi ditekankan di sini) */}
          <div className="flex items-center gap-2">
            {user ? (
              <button
                onClick={signOut}
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-bold text-rose-600 bg-rose-50 hover:bg-rose-100 hover:-translate-y-0.5 hover:shadow-sm active:scale-95 transition-all duration-300 ease-out cursor-pointer"
              >
              ...
              <>
                ...
                <NavLink 
                  to="/masuk" 
                  className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-bold text-slate-600 hover:bg-slate-50 hover:-translate-y-0.5 hover:shadow-sm active:scale-95 transition-all duration-300 ease-out"
                >
                  <LogIn size={16} /> Masuk
                </NavLink>
                
                {/* Tombol DAFTAR (Paling interaktif dengan bayangan dan perubahan warna) */}
                <NavLink 
                  to="/daftar" 
                  className="px-5 py-2.5 rounded-xl text-sm font-bold bg-teal-700 text-white hover:bg-teal-600 hover:-translate-y-0.5 hover:shadow-md hover:shadow-teal-700/30 active:scale-95 transition-all duration-300 ease-out"
                >
                  Daftar
                </NavLink>
              </>
